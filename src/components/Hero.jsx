        ...
        <div id="home" className="px-8 md:px-32 flex flex-col min-h-screen w-full items-center justify-center py-28">
            <div className="flex flex-col items-center justify-center gap-10">
                ...
                >
                    ...
                    <div className="text-3xl md:text-5xl font-bold leading-tight flex flex-wrap items-center justify-center gap-2">
                        <span style={{
                    ...
                    <div className="w-10 h-0.5 rounded-full bg-gradient-to-r from-blue-500 to-pink-500"></div>
                    ...
                    <div className="flex flex-wrap gap-3 justify-center mt-2">
                        ...
                        <a href="/Saifuddinkhan_new_Resume.pdf" download="Saifuddin-Khan-Resume.pdf"
